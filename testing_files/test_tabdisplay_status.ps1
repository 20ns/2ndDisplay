...
Write-Host "OK: TabDisplay is running" -ForegroundColor Green
...
Write-Host "6. Unfortunately, the current build does not have region capture"
Write-Host "7. You will see the full primary monitor mirrored for now"
Write-Host ""
